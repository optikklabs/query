...
func (h *Handler) GetTraceSummary(w http.ResponseWriter, r *http.Request) {
	...
	resp, err := h.svc.GetTraceSummary(r.Context(), tenantID, traceID, startMs, endMs)
	if err != nil {
...
func (h *Handler) GetSpanEvents(w http.ResponseWriter, r *http.Request) {
	...
	events, err := h.svc.GetSpanEvents(r.Context(), tenantID, traceID, startMs, endMs)
	if err != nil {
...
func (h *Handler) GetSpanAttributes(w http.ResponseWriter, r *http.Request) {
	...
	attrs, err := h.svc.GetSpanAttributes(r.Context(), tenantID, traceID, spanID, startMs, endMs)
	if err != nil {
...
func (h *Handler) GetTraceSpans(w http.ResponseWriter, r *http.Request) {
	...
	items, err := h.svc.ListSpansByTrace(r.Context(), tenantID, traceID, startMs, endMs)
	if err != nil {
