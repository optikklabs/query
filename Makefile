.PHONY: build run fmt vet test loadtest-smoke loadtest-all loadtest-traces loadtest-logs loadtest-metrics loadtest-overview loadtest-infrastructure loadtest-saturation loadtest-services
